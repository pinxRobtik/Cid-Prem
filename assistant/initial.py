...
STRINGS = {
    1: """ **Terima Kasih Telah Deploy ᴄɪᴅ ꭙ ᴘʀᴇᴍɪᴜᴍ!**

Beberapa Bantuan Untuk Kamu Pelajari.""",
    2: """🎉** Tentang ᴄɪᴅ ꭙ ᴘʀᴇᴍɪᴜᴍ**

❣ Dibuat oleh **@cidsupport**""",
    3: """
...
-> Kamu bisa membalas seseorang dari Cid-Premium Logs ketika kamu di tag oleh seseorang digrup lain.
