...
piic = "./resources/extras/logo.jpg"

buttons = [
    [
        Button.url(get_string("bot_4"), "t.me/cidsupport"),
    ]
]
...
in_alive = "<b>CID-Premium</b>\n<b>     status :</b> <code>{}</code>{}\n<b>       expired_on :</b> <code>{}</code>\n<b>       ping_dc :</b> <code>{}</code>\n<b>       version :</b> <code>{}</code>\n<b>       nayalibs :</b> <code>{}</code>\n<b>       uptime :</b> <code>{}</code>"

absen = [
    "**Hadir Sayang** 😳",
    "**Hadir Bro** 😁",
    "**Maaf ka habis nemenin Devs** 🥺",
    "**Maaf ka habis disuruh Devs** 🥺🙏🏻",
    "**Hadir Sayang** 😘",
    "**Hadir Devs Akuuuuhhh** ☺️",
    "**Hadir Devs** 🥰",
    "**Sokap bet lu**",
    "**Apasi Bawel** 🥰",
]
...
async def _(e):
    ...
    if m:
        ...
        await xx.edit(
            f'<code>Your BOT is </code><strong>up-to-date</strong><code> with </code><strong><a href="https://github.com/Pinxrobtik/Cid-Prem/tree/{branch}">[{branch}]</a></strong>',
            parse_mode="html",
            link_preview=False,
        )
